...
values (
  ...
  'After diagnosing a 44-step quiz funnel, I focused on the Enter Email step, the second-largest drop-off, and proposed testable content and CTA directions to make the value exchange feel clearer and more personalized.',
  ...
  '[
        ...
        "variants":[
          {
            ...
            "body":"This version makes the offer more specific by naming the Calisthenics plan directly. The hypothesis is that a clearer product label can make the email step feel more credible and less like generic lead capture.",
            "imageSrc":"/images/projects/Reversetech/cta-variant-1.svg"
          },
          {
            "label":"Variant 2",
            "title":"Get my calisthenics plan",
            "body":"This variant keeps the same product-specific headline, but presents the email ask in a slightly cleaner, more direct way. It tests whether reducing extra phrasing around the field makes the step feel faster while still giving users enough confidence to continue.",
    ...
    },
    {
      ...
      "payload":{
        "note":"As a result, the step feels more like lead capture than part of the personalized plan experience, so I proposed testing a few solutions. For the purpose of this task, I selected Variant 3 as the final design solution, but I think a good approach would be to A/B test a few ideas.",
        "variants":[
          {
            "label":"Variant 3",
            "title":"Variation: Category, Headline, Subtitle and Help Text",
            "body":"This variant introduces energetic results-focused message and ties the plan to a concrete fitness outcome. It is more motivational than the others, but it depends on strong relevance.",
