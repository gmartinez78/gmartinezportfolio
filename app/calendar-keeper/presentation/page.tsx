...
export default function CalendarKeeperPresentationPage() {
  return (
    <main className="min-h-screen snap-y snap-proximity overflow-y-auto bg-[#f8fbff] text-[#0e2951]">
      <SiteHeader />

      <section className="relative flex min-h-[calc(100svh-72px)] snap-start items-center overflow-hidden bg-[#0e2951] px-6 py-16 text-white md:px-10 xl:px-20">
        ...
        <div className="relative mx-auto max-w-[1120px]">
          ...
          <p className="mt-16 text-[11px] font-semibold uppercase tracking-[0.3em] text-[#83cef8]">Stakeholder presentation · 01 / 06</p>
      ...
      <section id="decision" className="mx-auto flex min-h-[calc(100svh-49px)] max-w-[1120px] snap-start items-center px-6 py-20 md:px-10 xl:px-0">
        <div className="w-full">
        <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#1183D0]">02 / 06 · The decision</p>
      ...
      <section className="flex min-h-[calc(100svh-49px)] snap-start items-center border-y border-[#d9e5f2] bg-white px-6 py-20 md:px-10 xl:px-20">
        <div className="mx-auto max-w-[1120px]">
          <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#1183D0]">03 / 06 · The problem we chose to solve</p>
      ...
      <section id="strategy" className="mx-auto flex min-h-[calc(100svh-49px)] max-w-[1120px] snap-start items-center px-6 py-20 md:px-10 xl:px-0">
        <div className="w-full">
        <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#1183D0]">04 / 06 · Strategy</p>
      ...
      <section id="design" className="snap-start border-y border-[#d9e5f2] bg-white px-6 py-20 md:px-10 xl:px-20">
        <div className="mx-auto max-w-[1120px]">
          <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#1183D0]">05 / 06 · The service and experience</p>
      ...
      <section id="ai" className="mx-auto flex min-h-[calc(100svh-49px)] max-w-[1120px] snap-start items-center px-6 py-20 md:px-10 xl:px-0">
        <div className="w-full">
        <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#1183D0]">06 / 06 · AI-assisted, human-directed</p>
      ...
      <section id="next" className="snap-start bg-[#0e2951] px-6 py-20 text-white md:px-10 xl:px-20">
