      ...
      <div className="overflow-hidden rounded-[32px] bg-[#f4f8ff]">
        ...
        <div className="min-h-[650px] p-4">
          <div className="flex items-center justify-between">
            <div><p className="text-[10px] font-bold tracking-[0.15em] text-[#2863d8]">CLARITY SCHEDULE</p><h3 className="mt-1 text-[18px] font-bold text-[#24324a]">{screen === "role" ? "Choose an entrance" : screen === "book" ? entrance === "patient" ? "Book a return visit" : "New appointment" : screen === "queue" ? "Action queue" : screen === "setup" ? "First bookable schedule" : "Calendar Keeper"}</h3></div>
