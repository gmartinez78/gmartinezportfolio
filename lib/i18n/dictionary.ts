...
export const dictionary = {
  ...
  "caseStudy.task4Optional": { en: "Task 4 — Optional", es: "Tarea 4 — Opcional" },
  ...
  "caseStudy.task4Description": {
    en: "A transparent breakdown of which tools I used at each stage, what I used them for, and what each one was optimized toward — speed, breadth, quality, or implementation.",
    es: "Un desglose transparente de qué herramientas usé en cada etapa, para qué las usé, y hacia qué estaba optimizada cada una: velocidad, amplitud, calidad o implementación.",
  },
