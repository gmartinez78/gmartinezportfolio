...
export const dictionary = {
  ...
  "tag.Embedded Product Teams": { en: "Embedded Product Teams", es: "Equipos de producto integrados" },
  ...
  "tag.Freelance Work": { en: "Freelance Work", es: "Trabajo freelance" },
  ...
  "caseStudy.task4": { en: "Task 4", es: "Tarea 4" },
  "caseStudy.task4Optional": { en: "Task 4 — Impact metrics", es: "Tarea 4 — Métricas de impacto" },
  "caseStudy.task5": { en: "Task 5 — How I used tools", es: "Tarea 5 — Cómo usé las herramientas" },
  "caseStudy.task5Short": { en: "Task 5", es: "Tarea 5" },
  ...
  "caseStudy.task4ImpactDescription": {
    en: "Set a measurable conversion target and the primary, diagnostic, and guardrail metrics needed to evaluate the proposed funnel experiments.",
    es: "Definir un objetivo de conversión medible y las métricas principales, de diagnóstico y de control necesarias para evaluar los experimentos de embudo propuestos.",
  },
